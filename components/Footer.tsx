  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-12 md:py-16 border-t border-gray-800">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl">
        ...
        {/* Mobile: 3 columns side-by-side, Desktop: 3 columns */}
        <div className="grid grid-cols-3 md:grid-cols-3 gap-4 md:gap-8 mb-8">
          ...
          <div>
            <h4 className="text-white font-bold mb-3 text-sm">Rechtliches</h4>
            <ul className="space-y-2 text-xs md:text-sm">
              <li>
          ...
          <div>
            <h4 className="text-white font-bold mb-3 text-sm">Kontakt</h4>
            <ul className="space-y-2 text-xs md:text-sm">
              <li>
                <a href={`mailto:${agencyConfig.contactEmail}`} className="hover:text-blue-400 transition-colors block">
                  {agencyConfig.contactEmail}
                </a>
              </li>
              <li>
                <a href={`tel:${agencyConfig.contactPhone.replace(/\s/g, '')}`} className="hover:text-blue-400 transition-colors block">
