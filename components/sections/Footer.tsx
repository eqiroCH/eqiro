    ...
    <footer className="bg-gray-900 text-gray-300 py-16 border-t border-gray-800">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <h4 className="text-white font-bold mb-4">{t.footer.navTitle}</h4>
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center">
                <span className="text-gray-500 w-20">{t.footer.locationLabel}</span>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <div className="mb-4 md:mb-0">
            &copy; {currentYear} {agencyConfig.agencyName}. {t.footer.rights}
          </div>
          <div className="flex space-x-6">
            <a href={agencyConfig.whatsappLink} target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition-colors" aria-label="WhatsApp">
